...
{
    public static class ExecStructV2
    {
        const int counter = 15_000_000;

        public static void Exec()
        {
            var listCoordinates = new List<CoordinatesStructV2>();
            var sw = new Stopwatch();

            for (var i = 0; i < counter; i++)
            {
                listCoordinates.Add(new CoordinatesStructV2
                {
                    Latitude = i,
                    Longitude = i
                });
            ...
            var find = new CoordinatesStructV2
            {
                Latitude = -1,
                Longitude = -1
            };
