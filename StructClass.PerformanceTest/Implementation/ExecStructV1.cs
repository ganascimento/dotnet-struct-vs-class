...
{
    public static class ExecStructV1
    {
        const int counter = 15_000_000;

        public static void Exec()
        {
            var listCoordinates = new List<CoordinatesStructV1>();
            var sw = new Stopwatch();

            for (var i = 0; i < counter; i++)
            {
                listCoordinates.Add(new CoordinatesStructV1
                {
                    Latitude = i,
                    Longitude = i
                });
            ...
            var find = new CoordinatesStructV1
            {
                Latitude = -1,
                Longitude = -1
            };
